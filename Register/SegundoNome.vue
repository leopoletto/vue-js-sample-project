  ...
  <section class="grid min-h-screen sm:pb-12 xl:grid-cols-0">
    ...
    <article>
      ...
      <div class="sm:px-5 xl:px-28">
        <h2 class="text-3xl font-semibold text-primary text-left xl:py-6 sm:py-4">Sobrenome</h2>
        <p class="pb-2">Qual é o seu sobrenome completo?</p>
        ...
        <form @submit.prevent="submit">
          <ul class="grid gap-5 pt-4">
            <li>
              ...
              <Input
                placeholder="Preencha o seu sobrenome aqui.."
                type="text"
                required
                v-model="segundoNome"
              />
...
export default {
  ...
  methods: {
    submit() {
      const primeiroNome = sessionStorage.getItem('nome')
      sessionStorage.setItem('nome', `${primeiroNome} ${this.segundoNome}`);
      location.href = "/register/apelido";
